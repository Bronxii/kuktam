...
class RecipeScaler {
  ...
  /// Selects units without rounding the mathematical quantity.
  ({double quantity, String unit}) normalizeForDisplay({
    required double quantity,
    required String unit,
  }) => const KitchenQuantityNormalizer().normalizeForDisplay(
    quantity: quantity,
    unit: unit,
  );
  ...
  String formatQuantity(double quantity, {String? unit}) {
    final rounded = KitchenQuantityNormalizer.roundQuantity(quantity, unit);
